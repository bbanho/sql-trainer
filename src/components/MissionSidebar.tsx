...
const MissionSidebar: React.FC<MissionSidebarProps> = ({ missions, currentId, onSelect, fontSize }) => {
  return (
    <div className="w-full h-full flex flex-col bg-ice-100 dark:bg-slate-900 border-r border-ice-300 dark:border-slate-800 transition-colors duration-200">
      ...
      <div className="p-4 border-b border-ice-300 dark:border-slate-800 bg-ice-200 dark:bg-slate-950">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  <span className={`font-mono text-[10px] py-0.5 px-1.5 rounded-none border ${
                    isActive 
      ...
      {/* Footer / Progress */}
      <div className="p-4 border-t border-ice-300 dark:border-slate-800 bg-ice-200 dark:bg-slate-950">
